...
export default function(app) {
    ...
    app.post('/signup', async(req, res) => {
        ...
        app.post('/signup', async(req, res) => {
                ...
                console.log("new singup,uname,email,password", username, email, password, username != null && email != null && password != null)
                try {
    ...
    app.post('/login', (req, res, next) => {
            ...
            console.log("/login before sendinfo")
            sendUserInfo(req, res);
        },
        (err, req, res, next) => {
            res.status(403).send(err);
